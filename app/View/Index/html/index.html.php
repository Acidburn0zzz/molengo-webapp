<div id="content" class="container">
    <div class="row">
        <div class="col-md-12">
            <h1>Welcome <small><?php wh(__('Demo')); ?></small></h1>
        </div>
    </div>
    <p></p>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Select multiple options</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page-header">Button groups</h1>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img data-src="holder.js/100%x200" alt="100%x200" src="data:image/svg+xml;base64," data-holder-rendered="true" style="height: 200px; width: 100%; display: block;">
                                    <div class="caption">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page-header">Linked items</h1>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="list-group">
                                ...
                                <a href="#" class="list-group-item list-group-item-text">Vestibulum at eros</a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page-header">Font Awesome Icons</h1>
                        </div>
